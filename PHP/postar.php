<!--Criado por Emanuele Santos - esantos@gvdasa.com.br-->
<!-- Para mudar a pasta de destino da imagem, autere "up/"-->
<!-- Este Script � simples, e s� aceita JPG pois n�o fiz condi��o que teste image/pjpg image/gif etc... -->
<!-- Se voc� fizer uma vers�o melhorada disto, favor envie para divino_rf@hotmail.com -->

<!-- Cat�logo de Produtos PHP SDB (Sem Banco de dados) V 0.9 Est�vel mas nem tanto, maio/2006 copyleft -->



<!--Por favor, n�o retire estas Linhas ACIMA-->
<?
