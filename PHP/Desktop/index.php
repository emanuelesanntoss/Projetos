<?
/*
Emanuele Santos --> esantos@gvdasa.com.br
*/
...
<body>
  <table width="100%" border="0">
    ...
    <tr>
      <td>
        <h3 align="center">Cadastrar usuario</h3>
      </td>
    </tr>
    <tr>
      <td>
        <form id="form1" name="form1" method="post" action="index.php?acao=cadastrar">
    ...
    <tr>
      <td>
        <h3 align="center">Alterar usuario</h3>
      </td>
    </tr>
    <tr>
      <td>
        <form id="form2" name="form2" method="post" action="index.php?acao=alterar">
          <table width="400" border="0" align="center">
            <tr><?
        ...
        <table width="40%" border="0" align="center" cellpadding="1" cellspacing="1">
          ...
          <?
            ...
            <tr>
              ...
              <td width="16%">
                <div align="center"><a href="index.php?acao=alt_form&id=<? echo $da_re['id']; ?>">Alterar</a></div>
              </td>
              <td width="14%">
                <div align="center"><a href="javascript:confirmaExclusao('index.php?id=<?php echo $da_re['id']; ?>&acao=excluir')">Excluir</a></div>
              </td>
            </tr>
          <? } ?>
        </table>
