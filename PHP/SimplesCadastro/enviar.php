...
<BODY>
  <DIV align=center>
    <CENTER>
      <TABLE id=AutoNumber1 style="BORDER-COLLAPSE: collapse" borderColor=#111111 height=424 cellSpacing=0 cellPadding=0 width=507 border=1>
        <TBODY>
          <TR>
          ...
          <TR>
            <TD align=justify width=507 height=402>
              <DIV align=center>
                <CENTER>
                  <TABLE id=AutoNumber1 style="BORDER-COLLAPSE: collapse" borderColor=#111111 height=200 cellSpacing=0 cellPadding=0 width=328 border=0>
                    <!--DWLayoutTable-->
                    <TBODY>
                      <TR>
                      ...
                      if (!$nome || !$email || !$assunto || !$mensagem) {
                        ...
                        echo "
                    <tr> 
                      <TD height=22 colspan=3> <p align=center><font face=Verdana size=1>Ol� 
                          <font color=#FF0000><b>$nome</b></font>,</font> 
                      </TD>
                    </tr>
                    <TR> 
                      <TD height=22 colspan=3> <p align=center><font face=Verdana size=1>as 
                          informa��es foram enviadas com sucesso!</font> </TD>
                    </TR>
                    <tr> 
                      <TD height=22> </TD>
                      <TD></TD>
                    ...
                    <TR> 
                      <TD height=23 colspan=3> <p align=center><font face=Verdana size=1>No 
                          m�ximo 48 horas entraremos em contato.</font> </TD>
                    </TR>
                    <tr> 
                      <TD height=23 colspan=3> <p align=center><font face=Verdana size=1>Atenciosamente!</font> 
                        ...
                        mail("emanuelesanntoss@gmail.com", "Formul�rio de contato", "$mens", $headers);
                        echo "                    <TR> 
                      <TD height=13> </TD>
                      <TD></TD>
                      <TD></TD>
                        ...
                        <TD height=12 colspan="3">
                          <p align="center">
                            <font face="Verdana" size="1">.:
                              Desenvolvido por <a href="mailto:emanuelesanntoss@gmial.com">Emanuele
                                ESantos</a> :: Vers�o 2.0 :.</font>
                        </TD>
                      </tr>
                    </TBODY>
                  </TABLE>
